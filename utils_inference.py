...
def get_model_by_name(model_name, root_models_path='hrnetv2_pretrained', prefix='HR18-', model_type='landmarks', device='cuda'):

    checkpoint_path = f'{root_models_path}/{prefix}{model_name}.pth'
    model_name_lower = str.lower(model_name)
    config_path = f'experiments/{model_name_lower}/face_alignment_{model_name_lower}_hrnet_w18.yaml'
